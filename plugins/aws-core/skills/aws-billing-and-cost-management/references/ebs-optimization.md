...
**io1/io2:**
Savings = (current_GB x $/GB + current_PIOPS x $/PIOPS) - (recommended_GB x $/GB + recommended_PIOPS x $/PIOPS)

**gp2->gp3:**
Savings = (current_GB x gp2_$/GB) - (current_GB x gp3_$/GB + max(0, needed_IOPS - 3000) x gp3_$/IOPS + max(0, needed_throughput_MBps - 125) x gp3_$/throughput_MBps)
