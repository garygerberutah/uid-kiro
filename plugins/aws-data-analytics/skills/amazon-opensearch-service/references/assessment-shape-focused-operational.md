...
> *Deeper: see `references/assessment-workflow.md` Section Path scoring; `references/assessment-gotchas.md` #2 for the snapshot block.*
...
- **Sizing tables** -- the customer is moving a small dataset; default a single `r7g.large.search` x 2 or whatever they have
