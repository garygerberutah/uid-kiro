...
> [SEARCH] **2 min in:** Agent querying CloudWatch for error rate across AZs...
> [FINDING] **5 min in:** Root cause -- memory limit reduced from 512MB to 256MB in last deploy.
