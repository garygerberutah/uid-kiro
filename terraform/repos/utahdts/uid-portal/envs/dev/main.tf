# ---------------------------------------------------------------------------
# dev validation/reference environment.
#
# Dev and AT share account 705157108110. The shared module hard-blocks a dev
# plan so this historical state cannot maintain a second gateway beside AT's
# uid-dev-api-gateway. Keep the root for validation and state reconciliation;
# deploy the non-production API only from envs/at.
# ---------------------------------------------------------------------------
