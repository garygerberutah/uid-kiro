...
|---|---|---|
| pgvector (embeddings, vector search) | [NO] | [YES] |
| PostGIS (geospatial) | [NO] | [YES] |
| pg_trgm (fuzzy text match) | [NO] | [YES] |
| Stored procedures / triggers | [NO] | [YES] |
| Multi-region active-active writes | [YES] | [NO] |
| No VPC required | [YES] | [YES] (Express) |
| Scale to zero (instant, no resume lag) | [YES] | [WARNING] (resume latency) |
| Time to first query | ~30s | ~90-120s (Express) |
| JOINs and ad-hoc queries | [YES] | [YES] |

If the workload requires a capability marked [NO] for a service, that service is excluded. For current DSQL feature support beyond this matrix, check the DSQL knowledge card.
