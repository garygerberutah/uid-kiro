...
| Dead man switch fires late | Total evaluation window (Periods x Period) exceeds one day | Multi-day alarms are evaluated once per hour -- expect delay beyond the configured period |
