...
# [WARNING] Present the fully-rendered template to the user and get explicit confirmation BEFORE the next line (see Step 3) -- never auto-start a destructive experiment
