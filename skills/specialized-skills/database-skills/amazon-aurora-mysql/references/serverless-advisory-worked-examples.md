...
Note what this reply does NOT include: no "0.21 x 4 x 4 = 3.36, round up to 3.5" arithmetic; no formula derivation; no "here's how I computed it." Just the script-style output.
...
3. Script output (db.r7g.2xlarge, 8 vCPU): min_ACU **8.0** (working-set floor 12/2 = 6.0 is satisfied), peak_ACU **21.0**, max_ACU **27.5** (= max(round_up(21.0 x 1.30), round_up(13.5 x 1.50))), typical_ACU **13.5**.
4. Costs: offline/static mode prices at **us-east-1 rates** ($0.12/ACU-hr, $0.10/GiB-mo storage) regardless of `--region`; only live API mode applies the eu-west-1 rate. Aurora serverless typical 13.5 x $0.12 x 730 = **$1,183/mo compute**, storage 1000 x $0.10 = $100, total**$1,283/mo**. Provisioned r7g.2xlarge: $1.106 x 730 = $807 + $100 = **$907/mo**. Recommendation: **not_recommended** -- serverless is ~41% more at this steady load.
