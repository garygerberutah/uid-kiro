...
7. **Pool sizing: total connections = replicas x max pool size per pod.** Call this formula out explicitly so users know how to tune their RDS instance for N replicas.
