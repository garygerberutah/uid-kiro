...
|---|---|---|
| LTS releases | [NO] Does not exist | [YES] Has LTS versions |
| Serverless mode | [NO] Does not exist | [YES] Aurora Serverless |
| I/O-Optimized storage | [NO] Does not exist | [YES] aurora-iopt1 |
| Data API | [NO] Not available for standalone RDS | [YES] Aurora Serverless clusters |
