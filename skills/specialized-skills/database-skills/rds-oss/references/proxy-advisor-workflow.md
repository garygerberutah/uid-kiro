...
- You MUST calculate connection utilization: `peak_connections / max_connections x 100`%
...
- You MUST categorize the result using these thresholds:
  - [RED] **Recommended**: peak connections > 80% of `max_connections`, OR Lambda/serverless callers present
  - [YELLOW] **Consider**: peak connections 50-80% of `max_connections`, OR frequent connection churn (spiky workload)
  - [GREEN] **Not recommended**: peak connections < 50% and stable connection patterns
...
- Monthly cost = `vCPUs x $0.015 x 730 hours`
