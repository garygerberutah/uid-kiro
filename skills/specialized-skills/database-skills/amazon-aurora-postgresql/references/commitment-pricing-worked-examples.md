...
4. Compute inline:
    - On-demand: 6 x $0.12 x 730 = **$526/mo compute**.
    - 1-year DSP No Upfront -- DSP's only payment option (serverless reaches up to ~35% off; actual rate varies by usage type per the DSP pricing page): at the ~35% serverless ceiling, $526 x 0.65 ~ **$342/mo**, saving **~$184/mo, ~35%**. There is no Partial/All Upfront DSP.
...
4. Compute inline -- on-demand: 4 x $0.58 x 730 = **$1,694/mo**.
    - 1-year RI All Upfront (~30%): $1,694 x 0.70 = **$1,186/mo**. Upfront ~ $14,222. Saves **$508/mo, ~30%**.
    - 3-year RI All Upfront (~55%): $1,694 x 0.45 = **$762/mo**. Upfront ~ $27,432. Saves **$932/mo, ~55%**.
...
User: "Should I buy reserved instances for my Aurora cluster `analytics-cluster` in us-west-2? 2x db.r7g.2xlarge running 24/7."
...
3. Compute inline (us-west-2 ~ 1.15x us-east-1):
    - On-demand: 2 x $1.28 x 1.15 x 730 = **$2,149/mo**.
    - 1-year RI All Upfront (~30%): **$1,504/mo** -- saves $645/mo, ~30%.
    - 3-year RI All Upfront (~55%): **$967/mo** -- saves $1,182/mo, ~55%.
    - 1-year DSP No Upfront -- DSP's only payment option (provisioned ceiling up to ~20%): $2,149 x 0.80 ~ **$1,719/mo** -- saves ~$430/mo, ~20%; smaller per-unit discount than the RI options here, but with size-flex (can reshape between r7g/r8g/serverless within commit).
