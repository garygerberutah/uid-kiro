...
User: 2x db.r6g.2xlarge, 800 GiB storage, 1.2 billion I/O requests per month, region us-east-1 (assumed), no AWS credentials.
...
3. Compute inline (db.r6g.2xlarge Standard rate $1.038/hr):
    - **Standard compute**: $1.038/hr x 730 x 2 = **$1,515/mo**.
    - **Standard storage**: 800 x $0.10 = **$80/mo**.
    - **Standard I/O**: 1,200 x $0.20 = **$240/mo**.
    - **Standard total**: $1,515 + $80 + $240 = **$1,835/mo**.
    - **I/O-Optimized compute**: $1.038 x 1.30 x 730 x 2 = **$1,970/mo**.
    - **I/O-Optimized storage**: 800 x $0.225 = **$180/mo**.
...
1. Announce reference: "Loading `references/commitment-pricing-instructions.md` (also relevant: `references/io-optimized-instructions.md` Section `skipped: true`)."
