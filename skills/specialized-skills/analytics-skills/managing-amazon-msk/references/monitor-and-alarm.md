...
2. **Static threshold (retention is known):** `Maximum > SUM(BytesInPerSec) x retention_seconds x 3` for 15 min (RF=3 on Express). Use this once the cluster has been running long enough to know steady-state ingress and retention is locked.
