...
[`solr-report-template.md`](../assets/solr-report-template.md), and the Section 7 split in [`assessment-shape-full-assessment.md`](assessment-shape-full-assessment.md).
...
## Section 1. Severity vocabulary (BLOCKING / HIGH / MEDIUM / LOW)
...
## Section 2. Lane vocabulary (`migration-specific` / `risk-blocker`)
...
## Section 3. Combining Severity + Lane
...
Examples grounded in the always-flag list at [`assessment-workflow.md` Section 3](assessment-workflow.md#step-3--compatibility-scan--gap-register):
...
## Section 4. Plugin rename cheat-sheet
