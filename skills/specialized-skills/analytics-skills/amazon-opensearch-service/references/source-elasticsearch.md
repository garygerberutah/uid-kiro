...
Use this to populate Section 1 "Recommended path" and Section 8 "Migration Plan" in the report.
...
Use as the audit checklist for Section 2 Schema/Mapping in the report and for [elasticsearch-index-template-skeleton.md](../assets/elasticsearch-index-template-skeleton.md).
