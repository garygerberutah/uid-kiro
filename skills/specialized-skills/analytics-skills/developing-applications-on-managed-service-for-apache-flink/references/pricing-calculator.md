...
| Running application storage | $0.10 / GB-month | **50 GB per KPU is included free.** Only the bytes *above* `KPU_count x 50 GB` are billable. Do not bill the 50 GB allocation itself. |
...
KPU_cost     = Total_KPUs x $0.11 x hours_per_month
storage_cost = max(0, state_GB - KPU_count x 50) x $0.10
backup_cost  = total_snapshot_GB x $0.023
...
- KPU cost: 3 x $0.11 x 730 = **$240.90**
- Running application storage: state <= 2 x 50 GB included -> **$0** (the 50 GB/KPU allocation is *included*, not separately billable; do **not** multiply 50 x $0.10 per KPU)
...
- KPUs: 8 + 1 = 9 -> 9 x $0.11 x 730 = **$722.70**
- Storage: 5 GB <= 8 x 50 GB included -> $0
- Snapshots: 5 GB x $0.023 = $0.12
- **Total: ~$723/month**

**Enterprise with autoscaling (avg 16 KPU, peak 32 KPU 20% of time, 60 GB state):**

- Peak: 33 x $0.11 x 146 = $530
- Off-peak: 17 x $0.11 x 584 = $1,092
- Snapshots: 60 GB x $0.023 = $1.38
- **Total: ~$1,623/month**
