...
### [NO] WRONG - Non-Deterministic Outside Steps
...
### [YES] CORRECT - Non-Deterministic Inside Steps
...
### [NO] WRONG - Repeated Side Effects
...
### [YES] CORRECT - Side Effects In Steps
...
```typescript
// [NO] WRONG if env vars can change
